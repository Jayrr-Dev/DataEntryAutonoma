...
; Data Entry Autonoma v1.1.1 — record clicks, scrolls, and keys; replay with presets or CSV batches.
...
C := {
    appVersion: "1.1.1", ; keep in sync with VERSION at project root
