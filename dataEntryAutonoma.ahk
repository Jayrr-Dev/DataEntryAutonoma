...
; Data Entry Autonoma v1.1.0 — record clicks, scrolls, and keys; replay with presets or CSV batches.
...
C := {
    appVersion: "1.1.0", ; keep in sync with VERSION at project root
